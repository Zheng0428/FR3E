...
class NaiveRewardManager:
    ...
    def __call__(self, data: DataProto):
        ...
        for i in range(len(data)):
            ...
            # print(f"[reward manager] data_source: {data_source}")
            try: # 第一轮rollout没有first_rollout_reward
                first_rollout_reward = data_item.non_tensor_batch["first_rollout_reward"]
                second_reward_rate = data_item.non_tensor_batch["second_reward_rate"]
            except:
                first_rollout_reward = None
                second_reward_rate = 1
            ...
            if isinstance(score_result, dict):
                raise NotImplementedError("compute_score ouput no dict")
            ...
            # [reward manager] data_source: simplelr_math_35
            # [reward manager]score: {'score': 1.0, 'extra_info': {'is_boxed_ratio': 1.0, 'score': 1.0}}
