...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None):
    ...
    elif 'simplelr' in data_source or 'big_math' in data_source:
        # from. import simplelr_math
        # res = simplelr_math.compute_score(solution_str, ground_truth)
        from . import hf_math_verify
        res = hf_math_verify.compute_score(solution_str, ground_truth, extra_info=extra_info)        
